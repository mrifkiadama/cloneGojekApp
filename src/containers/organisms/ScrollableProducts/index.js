...
import ScrollableItem from '../../../components/molecules/ScrolllableItem'
    ...
    render(){
        return(
            ...
            <ScrollView horizontal={true} style={{flexDirection:'row',paddingLeft:16}}>
              ...
              <ScrollableItem title="Bakmi GM Aeon Mall" img={require('../../../assets/dummy/go-food-orins.jpg')}/>
              <ScrollableItem title="Martabak Orins" img={require('../../../assets/dummy/go-food-banka.jpg')}/>
