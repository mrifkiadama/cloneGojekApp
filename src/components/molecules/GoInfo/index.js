...
const GoInfo = () => {
    return (
        ...
        <Text style={{fontSize:17,fontWeight:'bold',color:'#1C1C1C1',marginTop:15,marginBottom:20}}>Complete your Profile</Text>
        ...
        <TouchableOpacity style={{backgroundColor:'#61A756',paddingHorizontal:12,paddingVertical:11,alignSelf:'flex-end'}}>
            <Text style={{fontSize:13,fontWeight:'bold',color:'white'}}>CONNECT</Text>
          </TouchableOpacity>
